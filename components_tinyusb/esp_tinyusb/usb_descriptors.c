...
const char *descriptor_str_kconfig[] = {
    ...
    CONFIG_TINYUSB_DESC_VENDOR_STRING,       // 8: Vendor Interface
#else
    "",
#endif

#if CONFIG_TINYUSB_BTH_ENABLED
    "Espressif BTH device",                  // 9: BTH Interface
#else
    "",
#endif
...
enum {
    ...
    STRID_SERIAL,
#if CFG_TUD_CDC
    STRID_CDC_INTERFACE = 4,
#endif

#if CFG_TUD_MSC
    STRID_MSC_INTERFACE = 5,
#endif

#if CFG_TUD_NCM
    STRID_NET_INTERFACE = 6,
    STRID_MAC,
#endif

#if CFG_TUD_VENDOR
    STRID_VENDOR_INTERFACE = 8,
#endif

#if CFG_TUD_BTH
    STRID_BTH_INTERFACE = 9,
#endif
};
...
uint8_t const descriptor_cfg_kconfig[] = {
    ...
    TUD_VENDOR_DESCRIPTOR(ITF_NUM_VENDOR, STRID_VENDOR_INTERFACE, EPNUM_VENDOR, 0x80 | EPNUM_VENDOR, 64),
#endif

#if CFG_TUD_BTH
    TUD_BTH_DESCRIPTOR(ITF_NUM_BTH, STRID_BTH_INTERFACE, 0x80 | EPNUM_BTH_NOTIF, 8, 100, 0x80 | EPNUM_BTH_DATA, EPNUM_BTH_DATA, 64)
#endif
};
